...
def cap_img(hwnd=None):
    ...
    saveBitMap.CreateCompatibleBitmap(mfcDC, 56, 21)
    ...
    img_dc = mfcDC
    mem_dc = saveDC
    #  注意(56, 21) 和 (369, 179) 表示截取一部分图，从相对位置  (369, 179)开始截取 (56, 21) 大小的图
    mem_dc.BitBlt((0, 0), (56, 21), img_dc, (369, 179), win32con.SRCCOPY)
    # 将截图保存到文件中
